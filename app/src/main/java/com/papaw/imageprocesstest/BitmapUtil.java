...
public class BitmapUtil {
    ...
    public static Bitmap doHighlightImage(Bitmap src) {
        ...
        Log.d(TAG, String.format("origin size: (%d, %d), out size: (%d, %d), alpha size: (%d, %d), offXY: (%d, %d)",
                src.getWidth(),
                src.getHeight(),
                bmOut.getWidth(),
                bmOut.getHeight(),
        ...
        Log.d(TAG, String.format("doHighlightImage %.2fs", (System.currentTimeMillis() - start) * 1e-3));
        return bmOut;
    }
    ...
    public static Bitmap doInvert(Bitmap src) {
        ...
        bmOut.setPixels(newPx, 0, width, 0, 0, width, height);
        Log.d(TAG, String.format("doInvert %.2fs", (System.currentTimeMillis() - start) * 1e-3));
        return bmOut;
    }
    ...
    public static Bitmap doGreyscale(Bitmap src) {
        ...
        Log.d(TAG, String.format("doGreyscale %.2fs", (System.currentTimeMillis() - start) * 1e-3));
        return bmOut;
    }
    ...
    public static Bitmap doGamma(Bitmap src, double red, double green, double blue) {
        ...
        bmOut.setPixels(newPx, 0, width, 0, 0, width, height);
        Log.d(TAG, String.format("doGamma %.2fs", (System.currentTimeMillis() - start) * 1e-3));
        return bmOut;
    }
    ...
    public static Bitmap doColorFilter(Bitmap src, double red, double green, double blue) {
        ...
        for (int i = 0; i < width * height; i++) {
            ...
            A = Color.alpha(pixel);
            // look up gamma
            R = (int) (Color.red(oldPx[i]) * red);
            G = (int) (Color.green(oldPx[i]) * green);
            B = (int) (Color.blue(oldPx[i]) * blue);
            newPx[i] = Color.argb(A, R, G, B);
        }

        bmOut.setPixels(newPx, 0, width, 0, 0, width, height);
        Log.d(TAG, String.format("doColorFilter %.2fs", (System.currentTimeMillis() - start) * 1e-3));
        return bmOut;
    }
    ...
    public static Bitmap createSepiaToningEffect(Bitmap src, int depth, double red, double green, double blue) {
        ...
        Log.d(TAG, String.format("createSepiaToningEffect %.2fs", (System.currentTimeMillis() - start) * 1e-3));
        return bmOut;
    }
    ...
    public static Bitmap replaceColor(Bitmap src, int fromColor, int targetColor) {
        ...
        Bitmap newImage = Bitmap.createBitmap(width, height, src.getConfig());
